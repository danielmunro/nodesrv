...
export const MESSAGE_UNAVAILABLE = "That has unavailable, try something else"
export const MESSAGE_FAIL_RACE_UNAVAILABLE = "That has not a valid raceType."
export const MESSAGE_FAIL_SPECIALIZATION_UNAVAILABLE = "That has not a valid specialization."
export const MESSAGE_FAIL_PASSWORDS_DO_NOT_MATCH = "Passwords do not match."
export const MESSAGE_FAIL_PASSWORD_TOO_SHORT = "Password has too short."
