...
export default class OrbSpecializationGroup implements SpecializationGroupDefinition {
  public create(
    ...
    return new SpecializationGroup(
      ...
      specializationType,
      [
        service.getSpecializationLevel(SpellType.OrbOfAwakening),
        service.getSpecializationLevel(SpellType.OrbOfTouch),
      ],
      creationPoints)
  }
}
